    ...
    return (
        <>
            <div className="resume-container w-[85%] mx-auto my-7">
                <div className="header flex items-center justify-between w-full pb-3">
                    <div className="flex flex-col gap-2">
                        <h3 className="text-xl font-semibold">Your Resume</h3>
                        <p className="text-center text-sm text-gray-600">*This is just a random dummy resume used for design and layout purpose.</p>
                    </div>
