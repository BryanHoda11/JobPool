    ...
    return (
        <>
            <div className="header mx-4 my-2">
                <h2 className="text-lg sm:text-xl pb-3 font-semibold text-center">Explore job categories that fit your role!</h2>

                <div className="job-categories px-4 flex items-center mx-auto justify-start gap-2 w-full sm:w-[90%] overflow-x-auto whitespace-nowrap scrollbar-hide">
                    {Categories.map((c) => (
