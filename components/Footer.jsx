        ...
        <>
            <footer className="w-full h-auto relative mt-7 bg-white">
                <div className="links flex justify-around w-full mx-auto py-6">
                    ...
                    <div>
                        <h3 className='font-semibold text-xl'>Jobs by Categories</h3>
                    ...
                    <div>
                        <h3 className='font-semibold text-xl'>Jobs by Companies</h3>
                        <ul className='flex flex-col gap-3 pt-3'>
                ...
                <div className="flex items-center justify-center text-center mt-5 py-5 border-t w-[80%] mx-auto">
